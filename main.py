...
class User: # class is like an template
    def __init__(self, first, last, age, email, prob_parl):
        self.first = first
        self.last = last 
        self.age = age
...
class health_scv(services):
    ...
    title = 'name,   wesite,   description,   location,   phone,   email,   primary_care,   nsurance'.title()
...
def getUser(): 
    ...
    print()
    user = User(first_name, last_name, age, email_address, release_status)
    return user
